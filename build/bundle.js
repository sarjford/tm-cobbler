  ...
  _createClass(Shoes, [{
    ...
    value: function render(props) {
      ...
      var purchasedShoes = props.state.data.map(function (shoeData, i) {
        return (0, _preact.h)(_shoe2.default, { className: 'shoe', appState: props.state, state: shoeData, setAppState: props.setAppState, index: i });
      });
			...
			return (0, _preact.h)(
				...
				(0, _preact.h)(
					...
					(0, _preact.h)(
						'div',
						{ className: 'img' },
						(0, _preact.h)('img', { src: props.state.imageSrc })
					),
					(0, _preact.h)(
						'div',
						{ className: 'info' },
...
var Info = function (_Component) {
  ...
  _createClass(Info, [{
    ...
    value: function submitOrder(e) {
      ...
      // let orderObject = { a: 'b' }
      _superagent2.default.post('https://4cfb0fbc.ngrok.io/order').send(orderObject).set('Accept', 'application/json').then(function (res) {
...
var Confirmation = function (_Component) {
  ...
  function Confirmation() {
    ...
    var _this = _possibleConstructorReturn(this, (Confirmation.__proto__ || Object.getPrototypeOf(Confirmation)).call(this));
